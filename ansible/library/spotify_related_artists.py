...
description:
    - "Ansible module to get 20 related artists for a given artists. Artists can be provided via a JSON File
    which gets generated by using the ansible module spotify_search or Visit
...
options:
    ...
    artists_file:
        description:
          - JSON File containing a dict of artist names. Fore more information about the JSON structure
            see https://beta.developer.spotify.com/documentation/web-api/reference/artists/get-related-artists/.
        type: String
